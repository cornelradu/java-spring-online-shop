    ...
    SecurityFilterChain defaultSecurityFilterChain(HttpSecurity http) throws Exception {
        ...
        http.csrf((csrf) -> csrf.ignoringRequestMatchers("/saveMsg")
                ...
                .authorizeHttpRequests((requests) -> requests
                        ...
                        .requestMatchers("/dashboard/products/edit/**").authenticated()
                        .requestMatchers("/dashboard/products/update/**").authenticated()
                        .requestMatchers("/dashboard/products/search").authenticated()
                        .requestMatchers("/dashboard/products/search-form").authenticated()
